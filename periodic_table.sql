...
INSERT INTO public.properties VALUES (9, 'nonmetal', 18.998, 220.0, -188.1, 1);
...
--
-- Name: elements cons_name; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT cons_name UNIQUE (symbol, name);
